...
class LiftAndPlace(SingleArmEnv):
    """
    ...
    def reward(self, action=None):
        ...
        Un-normalized summed components if using reward shaping:
            ...
            - Placing: in [0,1] to encourage the arm to move block to a specific target location on the table
    ...
    def _check_placing_cube(self):
        """
        Check if cube has been placed down on target.

        Returns:
            bool: True if cube is touching target
        """
